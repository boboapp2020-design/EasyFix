...
const CACHE = 'easyfix-v18';
const SHELL = ['index.html', 'manifest.webmanifest', 'hero-banner.jpg', 'profile-banner.jpg', 'admin-banner.jpg', 'house.png', 'icon-192.png', 'icon-512.png',
