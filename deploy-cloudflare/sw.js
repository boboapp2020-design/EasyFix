...
const CACHE = 'easyfix-v31';
const SHELL = ['index.html', 'rights.js', 'manifest.json', 'hero-banner.jpg', 'profile-banner.jpg', 'admin-banner.jpg', 'house.png', 'icon-192.png', 'icon-512.png',
